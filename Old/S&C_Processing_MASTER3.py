...
## EXTRACT ADDED DATA    
    ...
    #%% DJ PROCESSING            
            ...
            # Calculate the body weight from Plate 1 and Plate 2
            BW1 = np.mean(P1F[0:1501])  # Body weight based on Plate 1
            BW2 = np.mean(P2F[0:1501])  # Body weight based on Plate 2
            ...
            print("Checking critical data sizes before processing:")
